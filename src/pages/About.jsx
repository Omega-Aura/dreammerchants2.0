    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-950 transition-colors duration-300 pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          <h1 className="scroll-fade-in text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
        ...
        <div className="max-w-4xl mx-auto">
          {/* Mission Statement */}
          <div className="scroll-slide-left bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-200/50 dark:border-gray-700/50 shadow-xl mb-12">
          ...
          {/* Values Grid */}
          <div className="scroll-stagger-container grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {/* Value 1 */}
          ...
          {/* CTA Section */}
          <div className="scroll-slide-right text-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-200/50 dark:border-gray-700/50 shadow-xl">
